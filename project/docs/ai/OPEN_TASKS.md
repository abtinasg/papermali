...
resolve pilot cutoffs, or advance research pointers.
...
for value extraction, real available_at assignment, cutoff resolution,
candidate/pair evidence capture, real accessibility scoring application,
Part 3B.2, Stage126, or modeling. Real extraction or scoring remains banned even
though Part 3B.1 / 3B.1A contracts are locked.
