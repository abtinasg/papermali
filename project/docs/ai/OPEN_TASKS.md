...
`next_research_action_id=stage125-part3b-evidence-capture`. Part 3B.1 is a
**maintenance** task (`stage125-part3b1-decision-lock`) and does **not** advance
those research IDs.
...
complete Part 3B or authorize real extraction/scoring.
...
**Still prohibited without explicit user authorization:** new network host contact
for value extraction, candidate/pair evidence capture, real accessibility scoring
application, Part 3B.2, Stage126, or modeling. Real extraction or scoring remains
banned even though Part 3B.1 contracts are locked.
