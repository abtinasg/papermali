...
- `stage125-part5-readiness-closure` — Stage125 Part 5 readiness closure (Gate 125.0; keep/drop/defer register; Stage126 M1 entry contract as readiness-only; integrity manifest); **no model fitting, no Stage126 authorization, no Stage126 start**
