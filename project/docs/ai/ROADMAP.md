...
15. `stage125-part3c-leakage-safe-dataset-finalization` — Leakage-safe dataset finalization under the locked six-month Jalali lag (four Gate B designs preserved; assumed availability operationalized; no Stage126 / modeling) ✅
...
- `stage125-part3c-leakage-safe-dataset-finalization` — Stage125 Part 3C leakage-safe dataset finalization (operationalize six-month Jalali lag on all four frozen Gate B designs; column-role map; offline deterministic rebuild); **no feature selection, no model fitting, no Stage126**
...
into leakage-safe pair datasets for all four Gate B designs. Next:
