...
def test_git_status_no_untracked_after_tests():
    """The test suite must not leave untracked files (no stray artifacts).
    Tracked files may be regenerated by the runner; only untracked files
    indicate a cleanup failure."""
