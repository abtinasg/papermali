...
def test_expected_active_workstream_advances_to_the_m3_gate():
    ...
    # Stage128 constants stay pinned as history, and so does the Phase 2
    # "…_human_review" label; the LIVE expectation has since advanced to the
    # Stage130 Phase 2 workstream pending human submission metadata.
