#!/usr/bin/env python3
"""Runner for Stage125 Part 3A — Accessibility & Pilot Protocol Lock.

Usage:
    python project/run_stage125_part3a.py --write
    python project/run_stage125_part3a.py --check
    python project/run_stage125_part3a.py --all-rows PATH --pairs PATH --write
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("=" * 70)
    print("Stage125 Part 3A — Accessibility & Pilot Protocol Lock")
    print("=" * 70)
    ...
    try:
        result = part3a.run(project_dir=ROOT, all_rows_path=all_rows_path,
                            pairs_path=pairs_path, output_dir=output_dir,
                            write=args.write)
    except part3a.QCFail as exc:
    ...
    print("modeling_started=false | part3a_protocol_locked=true | "
